...
<details>
  ...
  * **⚠️주의: 0이나 ''도 Falsy**
  ...
  console.log(setCount(0));  // 10 (0도 Falsy라서 기본값 사용됨)
...
<details>
  ...
  ```JavaScript
  // AND: 첫 Falsy에서 멈춤
  console.log(true && true && false && true);  // false(세 번째에서 멈춤)

  // OR: 첫 Truthy에서 멈춤
  console.log(false || false || true || false);  // true(세 번째에서 멈춤)
  ```
...
<details>
  ...
  console.log(display); // true (false가 무시됨)
  ```
</details>
